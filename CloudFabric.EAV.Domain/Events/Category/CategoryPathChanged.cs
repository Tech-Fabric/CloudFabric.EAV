...
namespace CloudFabric.EAV.Domain.LocalEventSourcingPackages.Events.Category
{
    public record CategoryPathChanged : Event
    {
        ...
        public CategoryPathChanged(Guid id, Guid entityConfigurationId, string currentCategoryPath, string newCategoryPath)
        {
        ...
        public void Deconstruct(out Guid entityConfigurationId, out string currentCategoryPath, out string newCategoryPath)
        {
