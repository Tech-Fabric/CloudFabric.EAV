...
public class EntityReferenceAttributeConfiguration : AttributeConfiguration
{
    ...
    public override void UpdateAttribute(AttributeConfiguration updatedAttribute)
    {
        ...
        if (ReferenceEntityConfiguration != updated.ReferenceEntityConfiguration
            || DefaultValue != updated.DefaultValue)
        {
            Apply(new EntityReferenceAttributeConfigurationUpdated(Id,
                    updated.ReferenceEntityConfiguration,
