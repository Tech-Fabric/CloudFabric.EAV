...
public class Tests
{
    ...
    {
        var entityRepository = _aggregateRepositoryFactory.GetAggregateRepository<ValueFromListAttributeConfiguration>();
        ...
        var valuesAttribute = await entityRepository.LoadAsync(
